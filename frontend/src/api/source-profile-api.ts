...
export const sourceProfileApi = {
  ...
  transition: (id: number, toState: 'active' | 'retired', lockVersion: number, expectedActiveId: number | null) =>
    api<SourceProfile>(`/source-profiles/${id}/transition`, json('POST', { to_state: toState, lock_version: lockVersion, expected_active_id: expectedActiveId })),
}
