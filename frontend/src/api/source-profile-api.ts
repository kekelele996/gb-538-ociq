...
import type { CreateSourceProfile, ProfileTransitionResult, SourceProfile } from '../types/source-profile'
...
export const sourceProfileApi = {
  ...
  transition: (id: number, toState: 'active' | 'retired', lockVersion: number) =>
    api<ProfileTransitionResult>(`/source-profiles/${id}/transition`, json('POST', { to_state: toState, lock_version: lockVersion })),
}
